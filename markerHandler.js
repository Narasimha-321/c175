...
AFRAME.registerComponent("markerhandler", {
 ...
 getDistance: function(e1A, e1B) {
  return elA.object3D.position.distanceTo(e1B. object3D. position);
 },
...
rotation:models[barcode]["placement_rotaion"],
scale_url:[barcode]["placement_scale"],
model_url:models[barcode]["model_url"]
  ...
  placeTheModel: function(modelName, models) {
    ...
    modelEl.setAttribute("visible", fasle);
